...
export const setupApi = {
  ...
  patchUser: (id, body, expected_updated_at, t) => api(`/api/setup/users/${id}`, t, { method: 'PATCH', body: JSON.stringify({ ...body, expected_updated_at }) }),
  userStatus: (id, is_active, expected_updated_at, t) => api(`/api/setup/users/${id}/status`, t, { method: 'PATCH', body: JSON.stringify({ is_active, expected_updated_at }) }),
  userRoles: (id, role_ids, expected_updated_at, t) => api(`/api/setup/users/${id}/roles`, t, { method: 'PUT', body: JSON.stringify({ role_ids, expected_updated_at }) }),
  ...
  roleStatus: (id, is_active, expected_updated_at, t) => api(`/api/setup/roles/${id}/status`, t, { method: 'PATCH', body: JSON.stringify({ is_active, expected_updated_at }) }),
  rolePermissions: (id, permission_ids, expected_updated_at, t) => api(`/api/setup/roles/${id}/permissions`, t, { method: 'PUT', body: JSON.stringify({ permission_ids, expected_updated_at }) }),
